...
@SpringBootTest
public class VerifyFlatPTXTests {

	//to test the price of cart after applying percentage offer to user
	@Test
		public void applyFlatPTXOfferTest() throws Exception {
		   	resetOffers();
		    ...
		    System.out.println(response.getCart_value()+"sall");	
		    Assert.assertEquals(160, response.getCart_value());
		}
