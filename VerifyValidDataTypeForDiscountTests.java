...
@SpringBootTest
public class VerifyValidDataTypeForDiscountTests {

// to test that only integer values are allowed for offer and cart values	
	@Test
		public void verifyInvalidDataTypeForDiscount() throws Exception {
		    resetOffers();
		    ...
		    // Step 2: Apply offer
		    ApplyOfferRequest applyOfferRequest = new ApplyOfferRequest(1, 1, 200); // user_id, restaurant_id, cart_value
		    ApplyOfferResponse response = applyOffer(applyOfferRequest);
		    Integer offerCheck = new Integer(offerRequest.getOffer_value());
		    Integer cartCheck = new Integer(applyOfferRequest.getCart_value());
		    if(cartCheck instanceof java.lang.Integer && offerCheck instanceof java.lang.Integer){
		    	isValidDiscount = true;
		    }
		    Assert.assertEquals(isValidDiscount, true);
		}
